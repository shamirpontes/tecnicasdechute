          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12 xl:gap-16 items-center">
            ...
            <div className="order-2 lg:order-1 text-center lg:text-left space-y-4 sm:space-y-6 md:space-y-8">
              ...
              animationDelay: '0.8s'
                ...
                <Button size="lg" className="w-full lg:w-auto bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-bold py-3 sm:py-4 px-4 sm:px-6 lg:px-8 rounded-xl md:rounded-2xl text-sm sm:text-base lg:text-lg transition-all duration-300 hover:scale-105 shadow-lg shadow-green-500/50 min-h-[48px] sm:min-h-[56px]" onClick={() => window.open('https://sun.eduzz.com/7WXQ8J429A?u=1', '_blank')}>
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 xl:py-32 px-4 relative z-10 overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl relative">
          ...
          <div className="mt-16 text-center">
            <div className="max-w-2xl mx-auto">
              <Button size="lg" className="w-full lg:w-auto bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-bold py-4 px-8 rounded-2xl text-lg transition-all duration-300 hover:scale-105 shadow-lg shadow-green-500/50 min-h-[64px]" onClick={() => window.open('https://sun.eduzz.com/7WXQ8J429A?u=1', '_blank')}>
                ...
                <div className="relative">
                  ...
                  <Card className="relative glass-card border-2 border-crimson-primary/40 cinematic-shadow hover-lift overflow-hidden bg-gradient-to-br from-white/95 via-white/90 to-white/95 backdrop-blur-xl">
                    ...
                    <CardContent className="relative z-10 p-4 sm:p-6 md:p-8 lg:p-12 text-center">
                      ...
                      {/* Botão principal */}
                      <Button size="lg" className="w-full bg-gradient-to-r from-green-600 to-emerald-700 hover:from-green-700 hover:to-emerald-800 text-white py-4 sm:py-6 md:py-8 text-sm sm:text-base md:text-lg lg:text-xl font-bold rounded-lg sm:rounded-xl md:rounded-2xl cinematic-shadow hover-lift border-0 group relative overflow-hidden transform hover:scale-105 transition-all duration-300 min-h-[48px] sm:min-h-[56px] md:min-h-[64px]" onClick={() => window.open('https://sun.eduzz.com/7WXQ8J429A?u=1', '_blank')}>
